...
%                                       first orbit.
%                                       
%           .date_a_min, ate_a_max: -   Must be added for .TypeMission equal to 1 or 3
...
switch TimeOption.TypeMission
    ...
    case 1
        ...
        %Finally, we compute the times from the increments of days (mjd2000) since date0.
    ...
    case 2
        ...
        %Calculating the mjd2000 of the date.
        mjd2000_d_max=date2mjd2000(date_d_max);
        
        %Finally, we compute the time from the increment of days (mjd2000) since date0.
        TimeOption.t_i_max=(mjd2000_d_max-mjd2000_0)*3600*24;
