function [printed_value,ERROR] = pork_chopPARPOLFORWHILE(orbital_parameters_1,orbital_parameters_2,TimeOption,mi)
...
m = 300;                                                    % number of steps in which the departure time will be discretized
n = 300;                                                    % number of steps in which the arrival time will be discretized
